...
import com.privacyscanner.databinding.ActivityPrivacyTipsBinding
...
class PrivacyTipsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityPrivacyTipsBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPrivacyTipsBinding.inflate(layoutInflater)
        setContentView(binding.root)

        setSupportActionBar(binding.toolbar)
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        supportActionBar?.title = "Privacy Tips"

        setupRecyclerView()
    }

    private fun setupRecyclerView() {
        val tips = buildTipsList()
        val adapter = TipsAdapter(tips)
        binding.recyclerTips.apply {
            layoutManager = LinearLayoutManager(this@PrivacyTipsActivity)
    ...
    private fun buildTipsList(): List<PrivacyTip> = listOf(
        ...
        PrivacyTip(
            ...
            steps = listOf(
                ...
                "The app will still work for most functions",
        ...
        PrivacyTip(
            ...
            steps = listOf(
                ...
                "Check for the orange dot indicator in Android 12+ — it shows when mic is in use",
                "Consider using physical privacy covers for your camera/mic if concerned"
            )
        ),
        PrivacyTip(
            icon = "📱",
        ...
        PrivacyTip(
            icon = "🛡️",
            title = "Review App Permissions Before Installing",
            ...
            steps = listOf(
                ...
                "Ask yourself: Does a flashlight app need microphone access? Probably not.",
                "Check app reviews and look for privacy-related complaints",
                "Consider alternative apps with fewer permission requirements"
            )
        ),
        PrivacyTip(
            icon = "🔔",
        ...
        PrivacyTip(
            ...
            description = "Accessibility services have the highest level of device access. Malware often abuses them.",
            steps = listOf(
                ...
                "Banking and password manager apps should never need accessibility access"
            )
        ),
        PrivacyTip(
            icon = "⚙️",
        ...
        PrivacyTip(
            ...
            steps = listOf(
                ...
                "Check that your device still receives security patches (older devices may not)",
